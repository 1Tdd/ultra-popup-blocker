...
(function () {
    ...
    // CSS Styles
    const STYLES = `
        .upb-btn{display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;padding:6px 14px!important;border-radius:2px!important;font-size:12px!important;font-weight:400!important;cursor:pointer!important;transition:background 0.1s,color 0.1s!important;line-height:1.2!important;outline:0!important;white-space:nowrap!important;font-family:monospace,"Courier New",Courier,sans-serif!important;text-transform:uppercase!important;letter-spacing:0.5px!important}
        ...
        .upb-inp{width:100%!important;padding:8px 10px!important;background:#0B0B0B!important;border:1px solid #444!important;border-radius:2px!important;color:#E0E0E0!important;font-size:12px!important;font-family:monospace,"Courier New",Courier,sans-serif!important;box-sizing:border-box!important;outline:none!important}
        ...
        .upb-del{color:#666!important;cursor:pointer!important;font-size:14px!important;line-height:1}
        .upb-del:hover{color:#FFF!important}
        ...
        .upb-toggle-switch { position: relative; display: inline-block; width: 32px; height: 16px; border: 1px solid #444; background: #080808; cursor: pointer; }
        .upb-toggle-switch input { opacity: 0; width: 0; height: 0; }
        .upb-slider { position: absolute; top: 0; left: 0; width: 14px; height: 14px; background-color: #444; transition: .1s; }
        input:checked + .upb-slider { background-color: #E0E0E0; transform: translateX(16px); }
